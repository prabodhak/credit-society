...
<div class="box-body">
	...
	<div class="form-group col-md-4">
		...
		<form:select name="guardianRelation"
	...
	<div class="form-group col-md-4">
		...
		<form:input type="text" name="guardianAddr1"
			...
			path="guardian.localAddress.addressLine1" />
	</div>
	<div class="form-group col-md-4">
		...
		<form:input type="text" name="guardianAddr2"
			...
			path="guardian.localAddress.addressLine2" />
	</div>
	<div class="form-group col-md-4">
		...
		<form:input type="text" name="guardianLandmark"
			...
			placeholder="Landmark" path="guardian.localAddress.landmark" />
	</div>
	<div class="clearfix"></div>
	<div class="form-group col-md-4">
		...
		<form:input type="text" name="guardianCity"
			...
			path="guardian.localAddress.city" />
	</div>
	<div class="form-group col-md-4">
		...
		<form:input type="text" name="guardianDistrict"
			...
			placeholder="District" path="guardian.localAddress.district" />
	</div>
	<div class="form-group col-md-4">
		...
		<form:input type="text" name="guardianState"
			...
			path="guardian.localAddress.state" />
	</div>
	<div class="clearfix"></div>
	<div class="form-group col-md-4">
		...
		<form:input type="text" name="guardianCountry"
			...
			placeholder="Country" path="guardian.localAddress.country" />
	</div>
	<div class="form-group col-md-4">
		...
		<form:input type="text" name="guardianPin"
			...
			path="guardian.localAddress.pincode" />
	</div>
	<div class="clearfix"></div>
</div>
<!-- /.box-body -->